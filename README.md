...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/weathered-firefly-ce6b)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/weathered-firefly-ce6b
```

A live public deployment of this template is available at [https://weathered-firefly-ce6b.templates.workers.dev](https://weathered-firefly-ce6b.templates.workers.dev)
